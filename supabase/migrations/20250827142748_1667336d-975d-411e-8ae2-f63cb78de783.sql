-- Atualizar função authenticate_clinic_user_secure para incluir financeiro_ativo
...
BEGIN
  ...
  SELECT id, nome, dashboard_ativo, feedbacks_ativos, agenda_ativa, financeiro_ativo
  INTO clinic_data
  ...
  RETURN QUERY SELECT 
    ...
    jsonb_build_object(
      ...
      'financeiro_ativo', clinic_data.financeiro_ativo
    );
END;
$function$;